...
import 'package:sos_hanoi/src/blocs/place_bloc.dart';
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                            title: Text(places.elementAt(index).name == null ? '' : (places.elementAt(index).name).toString()),
                            subtitle: Text(places.elementAt(index).address == null ? '' : (places.elementAt(index).address).toString()),
                             onTap: () {
                                print("on tap");
